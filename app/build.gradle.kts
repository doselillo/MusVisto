...
dependencies {
    ...
    // Firebase (multijugador): la BoM gobierna versiones. RTDB = estado en vivo
    // del bucle host↔clientes; Auth anónimo = identidad por asiento (reglas).
